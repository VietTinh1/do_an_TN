...
<body onload='time()' class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          <h3 class="tile-title">Tạo mới loại bluetooth</h3>
          <div class="tile-body">
            <form class="row" method="post" action="{{ route('postUpdateBluetoothType',['id'=>'0']) }}">
              @csrf
              <div class="form-group  col-md-4">
                <label class="control-label">Tên loại bluetooth</label>
          ...
          <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0" id="sampleTable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    <form class="row" method="post" action="{{ route('postUpdateBluetoothType',['id'=>$data->id]) }}">
                        @csrf
                        <div class="form-group  col-md-4">
                        <label class="control-label">Tên loại bluetooth</label>
                        <input class="form-control" type="text" name="name_classify" required>
