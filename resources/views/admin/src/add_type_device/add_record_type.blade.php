...
<head>
  <title>Thêm ghi âm | Quản trị Admin</title>
  <meta charset="utf-8">
  ...
  <main class="app-content">
    ...
    <div class="app-title">
      <ul class="app-breadcrumb breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Thêm loại ghi âm</a></li>
      </ul>
      <div id="clock"></div>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          <h3 class="tile-title">Tạo mới loại ghi âm</h3>
          <div class="tile-body">
            <form class="row" method="post" action="{{ route('postUpdateRecordType',['id'=>'0']) }}">
              @csrf
