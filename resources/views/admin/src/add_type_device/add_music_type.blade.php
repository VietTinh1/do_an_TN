...
<html lang="en">
<head>
  <title>Thêm nhạc | Quản trị Admin</title>
  <meta charset="utf-8">
  ...
  <main class="app-content">
    ...
    <div class="app-title">
      <ul class="app-breadcrumb breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Thêm loại nghe nhạc</a></li>
      </ul>
      <div id="clock"></div>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          <h3 class="tile-title">Tạo mới loại nghe nhạc</h3>
          <div class="tile-body">
            <form class="row" method="post" action="{{ route('postUpdateMusicType',['id'=>'0']) }}">
              @csrf
              <div class="form-group  col-md-4">
                <label class="control-label">Tên loại nghe nhạc</label>
          ...
          <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0" id="sampleTable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    <form class="row" method="post" action="{{ route('postUpdateMusicType',['id'=>$data->id]) }}">
                        @csrf
                        <div class="form-group  col-md-4">
                        <label class="control-label">Tên loại nghe nhạc</label>
                        <input class="form-control" type="text" name="name_classify" required>
